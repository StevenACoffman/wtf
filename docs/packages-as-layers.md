...
*   [](https://web.archive.org/web/20250809024809/https://www.linkedin.com/shareArticle?mini=true&url=https://www.gobeyond.dev/packages-as-layers/&title=Packages%20as%20layers%2C%20not%20groups "Share on LinkedIn")
*   [](https://web.archive.org/web/20250809024809/mailto:/?subject=Packages%20as%20layers%2C%20not%20groups&body=https://www.gobeyond.dev/packages-as-layers/ "Share via Email")
*   [](# "Copy link")

Four years ago, I wrote an article called [_Standard Package Layout_](https://web.archive.org/web/20250809024809/https://www.gobeyond.dev/standard-package-layout/) that tried to address one of the most difficult topics for even advanced Go developers: package layout. However, most developers still struggle with organizing their code into a directory structure that will grow gracefully with their application.
...
![](https://web.archive.org/web/20250809024809im_/https://www.gobeyond.dev/content/images/2021/01/Packages-As-Layers-Not-Groups---NoCircularDependencies.svg)
...
![](https://web.archive.org/web/20250809024809im_/https://www.gobeyond.dev/content/images/2021/01/Packages-As-Layers-Not-Groups---AddingThirdPackage-1.svg)
...
![](https://web.archive.org/web/20250809024809im_/https://www.gobeyond.dev/content/images/2021/01/Packages-As-Layers-Not-Groups---Stdlib-1.svg)
...
We'll be looking at an example application called [WTF Dial](https://web.archive.org/web/20250809024809/https://github.com/benbjohnson/wtf?ref=gobeyond.dev), so you can read the [introductory post](https://web.archive.org/web/20250809024809/https://www.gobeyond.dev/wtf-dial/) to understand more about it.
...
![](https://web.archive.org/web/20250809024809im_/https://www.gobeyond.dev/content/images/2021/01/Packages-As-Layers-Not-Groups---NaiveApproach-1.svg)
...
![](https://web.archive.org/web/20250809024809im_/https://www.gobeyond.dev/content/images/2021/01/Packages-As-Layers-Not-Groups---IsolateBusinessDomain.svg)
...
[dial.go#L14-50](https://web.archive.org/web/20250809024809/https://github.com/benbjohnson/wtf/blob/e23f5f00e0f48f54bd751cc264ea85c094f7d466/dial.go?ref=gobeyond.dev#L14-L50)
...
[dial.go#L81-L122](https://web.archive.org/web/20250809024809/https://github.com/benbjohnson/wtf/blob/e23f5f00e0f48f54bd751cc264ea85c094f7d466/dial.go?ref=gobeyond.dev#L81-L122)
...
![](https://web.archive.org/web/20250809024809im_/https://www.gobeyond.dev/content/images/2021/01/Packages-As-Layers-Not-Groups---FlattenHierarchy.svg)

### Repackaging packages

Breaking the dependency between packages allows us flexibility in how we use our code. For our application binary, `wtfd`, we still want `http` to depend on `sqlite` (see `[wtf/main.go](https://web.archive.org/web/20250809024809/https://github.com/benbjohnson/wtf/blob/main/cmd/wtfd/main.go?ref=gobeyond.dev#L180-L205)`) but for our tests we can change `http` to depend on our new `mock` package (see `[http/server_test.go](https://web.archive.org/web/20250809024809/https://github.com/benbjohnson/wtf/blob/main/http/server_test.go?ref=gobeyond.dev#L22-L59)`):

![](https://web.archive.org/web/20250809024809im_/https://www.gobeyond.dev/content/images/2021/01/Packages-As-Layers-Not-Groups---Repackaging--1-.svg)
...
Have question or comment? Please open a thread on the [WTF Dial GitHub Discussion board](https://web.archive.org/web/20250809024809/https://github.com/benbjohnson/wtf/discussions?ref=gobeyond.dev).

[](/web/20250809024809/https://www.gobeyond.dev/author/benbjohnson/)

### [Ben Johnson](/web/20250809024809/https://www.gobeyond.dev/author/benbjohnson/)[

](https://web.archive.org/web/20250809024809/https://x.com/benbjohnson)
